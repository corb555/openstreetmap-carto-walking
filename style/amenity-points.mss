...
#amenity-points {
  ...
  [feature = 'man_made_tower']["tower:type" = 'observation'][zoom >= 14],
  ...
  [feature = 'tourism_viewpoint'][zoom >= 15] {
    ...
    marker-fill: saturate(darken(@tourism, 20),30);
    marker-clip: false;
    marker-width: 12;
    [zoom >= 17] {
        marker-width: 15;
  ...
  [feature = 'aeroway_aerodrome']['int_access' = 'yes'][zoom >= 8][zoom < 17],
  ...
  [feature = 'waterway_waterfall'] {
    ...
    [zoom >= 16] {
      ...
      [zoom < 14] {
            marker-width: 18;
            marker-fill: darken(@waterfall, 20);
      }
    }
  }
...
#text-point[zoom >= 10] {
  ...
  [feature = 'amenity_ice_cream'][zoom >= 18] {
    ...
    text-size: 13; //@standard-font-size;
    text-wrap-width: @standard-wrap-width;
    text-line-spacing: @standard-line-spacing-size;
    // text-dy: 11;
    text-face-name: @standard-font;
  ...
  [feature = 'natural_peak']  [zoom >= 10] [score > 1700],
  //[feature = 'natural_peak']  [zoom >= 8] [score > 2000],
  [feature = 'natural_volcano'][zoom >= 13],
  [feature = 'natural_saddle'][zoom >= 15],
  [feature = 'mountain_pass'][zoom >= 14],
  [feature = 'mountain_pass']  [zoom >= 10] [score > 1300],
  ...
  [feature = 'waterway_waterfall'] {
    ...
    [zoom >= 16] {
      text-name: "[name]";
      text-size: @medium-font-size - 5;
      text-wrap-width: @standard-wrap-width;
      text-line-spacing: @standard-line-spacing-size;
      text-fill: darken(@waterfall, 30); //@water-text;
      text-dy: 20;
      text-face-name: @standard-font;
      text-halo-radius: @standard-halo-radius;
      text-halo-fill: @standard-halo-fill;
  ...
  [feature = 'military_danger_area'][is_building = 'no'] {
    ...
    [zoom >= 17] {
      ...
      text-fill: red; //darken(@military, 20%);
      text-face-name: @landcover-face-name;
      text-halo-radius: @standard-halo-radius;
      text-halo-fill: @standard-halo-fill;
    }
  ...
  [feature = 'leisure_pitch'] {
    ...
    [zoom >= 19][is_building = 'no'] {
      ...
      text-size: 10; // @highlight-font-size-z16 - 2;
      text-wrap-width: @landcover-wrap-width-size;
      text-line-spacing: @landcover-line-spacing-size;

      [way_pixels > 7000] {   // HIGHLIGHT TEXT: Land large size
        text-size: 13; // @highlight-font-size-z16 ;
        text-wrap-width: @landcover-wrap-width-size-big;
        text-line-spacing: @landcover-line-spacing-size-big;
      }

      [way_pixels > 30000] {   // HIGHLIGHT TEXT: VERY LARGE SIZE
        text-size: 16; // @highlight-font-size-z16 + 6 ;
      ...
      [feature = 'amenity_college'],
      [feature = 'amenity_university'] {
        //text-fill: darken(@societal_amenities, 40%);
      }
      //[feature = 'landuse_religious'] {
      ...
      [feature = 'natural_beach'],
      [feature = 'natural_shoal'] {
        text-fill: darken(@beach, 35%);
      }
      [feature = 'leisure_sports_centre'],
      [feature = 'leisure_stadium'] {
        text-fill: darken(@stadium, 35%);
      }
      [feature = 'leisure_fitness_centre'],
      [feature = 'leisure_fitness_station'] {
        text-fill: @leisure-color;
  ...
  [feature = 'aeroway_aerodrome']['int_access' = 'yes'][zoom >= 11][zoom < 17],
  ...
  [feature = 'tourism_attraction'][zoom >= 17] [way_pixels > 5],
   [feature = 'tourism_attraction'][zoom >= 17] [height > 20]{
    text-name: "[name]";
