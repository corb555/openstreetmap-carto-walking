...
#placenames-small::suburb {
  [place = 'suburb'][zoom >= 13][zoom < 17] {
    ...
    text-margin: 7.7; // 0.7 em
    [zoom >= 14] {
      text-fill: lighten(desaturate(@placenames, 20), 20);
      text-size: 12;
      text-wrap-width: 60; // 5.0 em
